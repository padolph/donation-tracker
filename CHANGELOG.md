...
## [1.9.0](https://github.com/padolph/donation-tracker/compare/v1.8.1...v1.9.0) (2026-07-01)
...
* add hierarchical browse feature for item selection ([5617b1f](https://github.com/padolph/donation-tracker/commit/5617b1f64384100d7de5ec833d1892bc65e7cc7f))
...
* add icons for packaged app ([74cf5fe](https://github.com/padolph/donation-tracker/commit/74cf5febb2f96fc8b6039129e4e2beecc6ac212a))
...
* add read-only display of image storage path to settings page ([b6f75e2](https://github.com/padolph/donation-tracker/commit/b6f75e24095384cd500fd4f2041bcd2a46375c1a))
...
* display read-only database path on settings page and add ANTIGRVITY.md ([f1d3580](https://github.com/padolph/donation-tracker/commit/f1d35804afb55c743df514eb30b788ef8e9de982))
...
* **electron:** handle production environment variables and dynamic database path ([5c42ca0](https://github.com/padolph/donation-tracker/commit/5c42ca0afb88e2c80bede1442cd4273172ae23cf))
...
* implement 2026 OBBBA tax savings compliance engine ([4e5846e](https://github.com/padolph/donation-tracker/commit/4e5846eaa6dcc4136dfedfdaef1647156001a3aa))
...
* implement annual tax reporting dashboard and archival export ([b4955cd](https://github.com/padolph/donation-tracker/commit/b4955cd911e2af7105f5329394a5d8cca414f5e7))
...
* implement Electron wrapper with production readiness fixes ([6f8801c](https://github.com/padolph/donation-tracker/commit/6f8801cdc97c2fee400308b88e85c278022bd2a4))
...
* implement User Story [#3](https://github.com/padolph/donation-tracker/issues/3) (Organization Management) and fix item search ([ab21b25](https://github.com/padolph/donation-tracker/commit/ab21b2530056eaa3ef92675047a7c9f53bf2807d))
...
* implement User Story [#4](https://github.com/padolph/donation-tracker/issues/4) Donation Ledger & Browsing with edit and delete capabilities ([65c478f](https://github.com/padolph/donation-tracker/commit/65c478f9bdac28be00485e7cb32d41153296d08d))
...
* remove nonfunctional Dashboard and Sidebar cards ([839960b](https://github.com/padolph/donation-tracker/commit/839960be09c8f04a4ea6702b331d1ce3eec3885b))
...
* **actions:** clean up associated photo files when a donation is deleted ([fefecd0](https://github.com/padolph/donation-tracker/commit/fefecd0d70b14f5c8e3c314b552e4d6719ce3564))
...
* add image loading retry mechanism for sidebar app icon ([#85](https://github.com/padolph/donation-tracker/issues/85)) ([e8c08f2](https://github.com/padolph/donation-tracker/commit/e8c08f24b6634eaf288e98a32231592070b8f444))
...
* **ci:** configure release-please to use draft releases ([0cda83d](https://github.com/padolph/donation-tracker/commit/0cda83d36abc9225c71359cccb02d8a574c84d93))
* **ci:** rebuild electron native modules for linux and align prisma binary targets ([89613e7](https://github.com/padolph/donation-tracker/commit/89613e76784ca105df4a7302bfa85570ec4f28ab))
...
* **ci:** target both x64 and arm64 architectures on macOS ([87352f2](https://github.com/padolph/donation-tracker/commit/87352f23cf3094e5e55541c9ffdb32276a2628ad))
...
* **donations:** restrict condition dropdown to High and Medium and resolve relative database path mismatch ([1a0d191](https://github.com/padolph/donation-tracker/commit/1a0d19166e0ea3b6a3f4d2008d4b92b09717962b)), closes [#83](https://github.com/padolph/donation-tracker/issues/83)
...
* **electron:** assign DATABASE_URL to process.env before Next.js initialization ([ca492f2](https://github.com/padolph/donation-tracker/commit/ca492f2f2b0859ea9af7b3251499649479d6333d))
...
* Fix/release please tag prefix ([9672fcf](https://github.com/padolph/donation-tracker/commit/9672fcf82b6029d674872019c04999315acacb59))
...
* make database path override dynamic and package seeded production template ([ea0b8b2](https://github.com/padolph/donation-tracker/commit/ea0b8b20a94cbd64ffd6ba7c3209e3279805a158))
...
* prevent item duplication and make seeding idempotent ([f1d604a](https://github.com/padolph/donation-tracker/commit/f1d604af56e4c8a85fa196cea96ea82808cd9a55))
...
* **reports:** format asset donations with ticker as description, shares as quantity, and total value as unitValue ([37e54f5](https://github.com/padolph/donation-tracker/commit/37e54f53fcb592b217345396363d03b54ef54075)), closes [#70](https://github.com/padolph/donation-tracker/issues/70)
...
* resolve hydration mismatch in ReportClient timestamp ([e741b29](https://github.com/padolph/donation-tracker/commit/e741b298d0f36d38d409a06152b9695f1ec2e03c))
...
* sync react and react-dom versions ([b38405c](https://github.com/padolph/donation-tracker/commit/b38405c7beb8008191f01b8310b17f6b0c9b8bf8))
...
* **test:** dynamically check sidebar version from package.json ([156c8ee](https://github.com/padolph/donation-tracker/commit/156c8ee4e47e4fc803c7a8f9ec174e23f6ae199c))
...
* **ui:** correct application name to DonationTracker in layout, sidebar, and login ([4e26658](https://github.com/padolph/donation-tracker/commit/4e266585887a9e79b98017b2e291895b4b1f38f0))
...
* **ui:** rename adjust tax rate button to adjust tax settings on dashboard ([d14ac8d](https://github.com/padolph/donation-tracker/commit/d14ac8d8ad9a14916b36714595cedf2b72021596)), closes [#68](https://github.com/padolph/donation-tracker/issues/68)
